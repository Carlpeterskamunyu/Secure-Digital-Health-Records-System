...
<body>
	<div class = "navbar navbar-default navbar-fixed-top">
		<img src = "../images/logo.png" style = "float:left;" height = "55px" /><label class = "navbar-brand">Secure Digital Health Records System</label>
			<?php
				$conn = new mysqli("localhost", "root", "", "hcpms") or die(mysqli_error());
	...
	<div id = "footer">
		<label class = "footer-title">&copy; The_invincible 2024</label>
	</div>
	<script type = "text/javascript">
